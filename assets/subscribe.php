...
if($_POST) {
    ...
    if(!isEmail($subscriber_email)) {
        $array = array();
        $array['valid'] = 0;
        $array['message'] = 'Agregue una dirección de correo valida!';
        echo json_encode($array);
    }
    else {
        $array = array();
        $array['valid'] = 1;
        $array['message'] = 'Gracias por su Pre-Registro!';
        echo json_encode($array);

        // Send email
        $subject = 'New Subscriber QuincenaMe!';
